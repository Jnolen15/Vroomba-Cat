class Play extends Phaser.Scene {
    ...
    create() {
        ...
        this.timerText = this.add.text(0, 0, 'Time: ', textConfig).setOrigin(0);
        ...
        this.scoreText = this.add.text(0, 0, 'Score: ', textConfig).setOrigin(1,0);
        this.positionUIForCam(this.scoreText, game.config.width * .95, game.config.height * .05);

        // Displaying combo meter
        this.comboText = this.add.text(0, 0, 'Streak: 0 - Multiplier: x1', textConfig).setOrigin(1,0);
        this.positionUIForCam(this.comboText, game.config.width * .95, game.config.height * .1);
        this.comboMeter = this.add.sprite(0, 0, 'comboMeter').setOrigin(1,0);
